 ...
 */
package cn.stylefeng.guns.modular.web.wrapper;
 ...
 * @date 20190429
 */
public class CourseWrapper extends BaseControllerWrapper {

    public CourseWrapper(Map<String, Object> single) {
        super(single);
    }

    public CourseWrapper(List<Map<String, Object>> multi) {
        super(multi);
    }
