...
public class ApiResponseUtil {
    ...
    public static final Object fail409() {
        return fail(409, "无效的参数");
    }
    public static final Object fail409(String msg) {
        return fail(409, "无效的参数：" + msg);
    }

    public static final Object illegalRequest(){
        return fail(407,"非法请求.");
    }
    public static final Object illegalRequest(String msg){
        return fail(407,"非法请求:"+ msg );
    }
    ...
    public static final Object fail601() {
        return fail(601, "商品库存不足");
    }
